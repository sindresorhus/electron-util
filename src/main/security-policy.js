...
exports.setContentSecurityPolicy = void 0;
...
`);
*/
var setContentSecurityPolicy = function (policy, options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!policy
                    ...
                    .every(function (line) { return line.endsWith(';'); })) {
                    throw new Error('Each line must end in a semicolon');
                }
                policy = policy.replace(/[\t\n]/g, '').trim();
                options = __assign({ session: electron_1.session.defaultSession }, options);
                options.session.webRequest.onHeadersReceived(function (details, callback) {
                    callback({
                        responseHeaders: __assign(__assign({}, details.responseHeaders), { 'Content-Security-Policy': [policy] }),
                    });
                });
                return [2 /*return*/];
        }
